...
class bonsortieController extends Controller
{
    ...
    public function index()
    {
        ...
        // Charger les bons de sortie associés à l'utilisateur connecté
        $stockSorties = StockSortie::where('emetteur', $user->id_utilisateur)
        ...
        return view('bon-sortie.index', compact('stockSorties'));
    }
    ...
    public function create()
    {
        ...
        return view('bon-sortie.create', compact('utilisateurs', 'articles'));
    }
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            return redirect()->route('bon-sortie.index')->with('success', 'Bon de sortie ajouté avec succès.');
    ...
    public function edit($id)
    {
        ...
        $articles = Article::all();
        $utilisateurs = Utilisateur::all();
        return view('bon-sortie.edit', compact('stockSortie', 'articles', 'utilisateurs'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        try {
            ...
            return redirect()->route('bon-sortie.index')->with('success', 'Bon de sortie mis à jour avec succès.');
    ...
    public function destroy($id)
    {
        try {
            ...
            return redirect()->route('bon-sortie.index')->with('success', 'Bon de sortie supprimé avec succès.');

        } catch (\Exception $e) {
            Log::error('Error in destroy method:', ['exception' => $e]);
            return redirect()->route('bon-sortie.index')->with('error', 'Erreur lors de la suppression du bon de sortie.');
        }
    }
    ...
    public function show($id)
    {
        try {
            ...
            return view('bon-sortie.show', compact('stockSortie'));
        } catch (\Exception $e) {
            Log::error('Error in show method:', ['exception' => $e]);
            return redirect()->route('bon-sortie.index')->with('error', 'Bon de sortie non trouvé.');
        }
    }
}
