...
class bonEntrerController extends Controller
{
    ...
    public function index()
    {
        ...
        // Charger les bons d'entrée associés à l'utilisateur connecté
        $stockEntrers = StockEntrer::where('emetteur', $user->id_utilisateur)
                                    ->orWhere('recepteur', $user->id_utilisateur)
                                    ->get();
        ...
        return view('bon-entree.index', compact('stockEntrers'));
    }
    ...
    public function create()
    {
        ...
        return view('bon-entree.create', compact('utilisateurs', 'articles'));
    }
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            return redirect()->route('bon-entree.index')->with('success', 'Bon d\'entrée ajouté avec succès.');

        } catch (\Exception $e) {
            Log::error('Error in store method:', ['exception' => $e]);
            return redirect()->back()->withInput()->withErrors(['general' => 'Erreur lors de l\'ajout du bon d\'entrée.']);
        }
    }
    ...
    public function edit($id)
    {
        ...
        $articles = Article::all();
        $utilisateurs = Utilisateur::all();
        return view('bon-entree.edit', compact('stockEntrer', 'articles', 'utilisateurs'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        try {
            ...
            return redirect()->route('bon-entree.index')->with('success', 'Bon d\'entrée mis à jour avec succès.');
    ...
    public function destroy($id)
    {
        try {
            ...
            return redirect()->route('bon-entree.index')->with('success', 'Bon d\'entrée supprimé avec succès.');

        } catch (\Exception $e) {
            Log::error('Error in destroy method:', ['exception' => $e]);
            return redirect()->route('bon-entree.index')->with('error', 'Erreur lors de la suppression du bon d\'entrée.');
        }
    }
    ...
    /**
     * Affiche les détails d'un bon d'entrée.
     *
     * @param  int  $id
     * @return \Illuminate\View\View
     */
    public function show($id)
    {
        try {
            ...
            return view('bon-entree.show', compact('stockEntrer'));

        } catch (\Exception $e) {
            Log::error('Error in show method:', ['exception' => $e]);
            return redirect()->route('bon-entree.index')->with('error', 'Bon d\'entrée non trouvé.');
        }
    }
}
